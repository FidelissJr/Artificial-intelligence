...
class PSOw:
    def __init__(self, func, n_particles=50, n_iterations=5000, dim=5,
                 c1=1.5, c2=1.5, w_max=0.95, w_min=0.6,
                 bounds=(-32.768, 32.768), vmax_ratio=0.1):
        self.func = func
...
def run_pso_run(run_id):
    ...
    pso = PSOw(ackley, n_particles, n_iterations, dim)
...
plt.title('Convergência das 10 Runs do PSOw (Ackley - 10D)')
plt.yscale('log')
plt.legend()
plt.grid(True)
